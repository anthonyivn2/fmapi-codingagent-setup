...
- **Automatic OAuth token * &mdash; no PATs to rotate or manage
...
Install with a single command (clones to `~/.fmapi-codingagent-setup/`):
...
Alternatively, clone the repo manually to any location:
